...
public:
    ...
    WlObject(const WlObject&) requires WlObjectSpecListener<spec>
    = delete;
    WlObject(WlObject&&) noexcept requires WlObjectSpecListener<spec>
    = delete;
    WlObject& operator=(const WlObject&) requires WlObjectSpecListener<spec>
    = delete;
    WlObject& operator=(WlObject&&) noexcept requires WlObjectSpecListener<spec>
    = delete;
    ...
    WlObject(const WlObject&) requires(!WlObjectSpecListener<spec>) = default;
    WlObject(WlObject&&) noexcept requires(!WlObjectSpecListener<spec>) = default;
    WlObject& operator=(const WlObject&) requires(!WlObjectSpecListener<spec>) = default;
