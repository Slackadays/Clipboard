...
public:
    ...
    WlObject(WlObject const&) requires WlObjectSpecListener<spec>
    = delete;
    WlObject(WlObject&&) noexcept requires WlObjectSpecListener<spec>
    = delete;
    WlObject& operator=(WlObject const&) requires WlObjectSpecListener<spec>
    = delete;
...
private:
    static inline constexpr char const* interfaceName() { return spec::interface.name; }
