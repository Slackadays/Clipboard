...
install_precompiled_section() {
    ...
    then
        download_link=https://nightly.link/Slackadays/Clipboard/workflows/main/main/clipboard-macos-arm64-amd64.zip -o clipboard-macos.zip
    else
        download_link="skip"
    fi
    ...
    if ! 7z 
    then
        echo "Please install a .zip extracter, such as 7z or unzip."
        exit 1
    fi
