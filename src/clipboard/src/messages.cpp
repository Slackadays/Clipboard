...
ActionArray<std::string_view, 8> doing_action = { "Cutting",
                                                  "Copying",
                                                  "Pasting",
                                                  "Clearing"
                                                  "Editing"
...
ActionArray<std::string_view, 8> did_action = { "Cut",    "Copied", "Pasted", "Cleared",
                                                "Showed", "Edited", "Added",  "Removed" };

Message help_message =
        "[blue]▏This is Clipboard %s (commit %s), the cut, copy, and paste system for the command line.[blank]\n"
...
Message clipboard_item_one_contents_message =
        "[blue]• Here is the [bold]%i[blank][blue] item in clipboard [bold]%s[blank][blue]: [blank]\n";
Message clipboard_item_many_contents_message =
        "[blue]• Here are the [bold]%i[blank][blue] items in clipboard [bold]%s[blank][blue]: [blank]\n";
Message clipboard_item_too_many_contents_message =
        "[blue]• Here are the first [bold]%i[blank][blue] items in clipboard [bold]%s[blank][blue]: [blank]\n";
Message clipboard_text_contents_message =
        "[blue]• Here are the first [bold]%i[blank][blue] bytes in clipboard [bold]%s[blank][blue]: [blank]\n";
...
Message fix_redirection_action_message =
        "[red]╳ You can't use the [bold]%s[blank][red] action with redirection here. [pink]Try removing "
...
void setLanguageES() {
    ...
    no_valid_action_message =
            "[red]╳ No especificaste ninguna acción válida o se te olvidó. [pink]Inténta usar o añadir [bold]cortar, "
    ...
    fix_redirection_action_message =
            "[red]╳ No se puede usar la acción [bold]%s[blank][red] con la redirección. [pink]Inténta sacar "
...
void setLanguagePT() {
    ...
    no_valid_action_message =
            "[red]╳ Você não especificou uma ação válida (\"%s\"), ou esqueceu de incluí-la. [pink]Tente utilizar "
            "[bold]recortar, copiar ou colar[blank][pink], como em [bold]clipboard copiar.[blank]\n";
    no_clipboard_contents_message =
            "[red]╳ Você não especificou uma ação válida. [pink]Tente adicionar [bold]recortar, copiar, or "
    ...
    choose_action_items_message =
            "[red]╳ Você precisa especificar algo para %s.[pink] Tenta adicionar os itens que você quer %s ao final, "
            "como em [bold]clipboard %s contatos.txt meuprograma.cpp[blank]\n";
    fix_redirection_action_message =
            "[red]╳ Você não pode [bold]%s[blank][red] com redirecionamento aqui. [pink]Tente remover "
...
void setLanguageTR() {
    ...
    help_message =
            "[blue]▏Clipboard %s (commit %s), komut satırı için, kesme, kopyalama ve yapıştırma sistemidir.[blank]\n"
    ...
    clipboard_item_many_contents_message =
            "[blue]• [bold]%s[blank][blue] panoda bulunan ilk [bold]%i[blank][blue] öğe: [blank]\n";
    no_clipboard_contents_message = "[blue]• Panoda hiçbir şey yok.[blank]\n";
    clipboard_action_prompt =
            "[pink]Başlamak için sonuna [bold]kes, kopyala, [blank][pink]veya[bold] yapistir[blank][pink] ekleyin, "
    ...
    no_valid_action_message =
            "[red]╳ Geçerli bir işlem vermediniz (\"%s\") veya işlem vermeyi unuttunuz [pink]Komutunuza [bold]cut, "
            "copy, [blank][pink]ya da [bold]paste[blank][pink] eklemelisiniz, örneğin [bold]clipboard copy.[blank]\n";
    choose_action_items_message =
            "[red]╳ %s(ma/me) işlemi için bir öğe seçmeniz gerekmektedir.[pink] %s işleminden sonra öğeler eklemeyi "
            "deneyiniz, örneğin [bold]clipboard %s contacts.txt myprogram.cpp[blank]\n";
    fix_redirection_action_message =
            "[red]╳ [bold]%s[blank][red](ma/me) işlemini burada yeniden yönlendirme ile kullanamazsın. [pink] "
