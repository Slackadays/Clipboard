...
Message item_already_exists_message = "{yellow}• The item {bold}%s{blank}{yellow} already exists here. Do you want to replace it? {pink}Use {bold}all {blank}{pink}to replace all existing, or {bold}skip{blank}{pink} to replace nothing. {bold}[(y)es/(n)o)/(a)ll/(s)kip] ";
