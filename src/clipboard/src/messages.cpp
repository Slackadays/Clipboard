...
EnumArray<std::string_view, 9> actions = {"cut", "copy", "paste", "clear", "show", "edit", "add", "remove", "swap"};

EnumArray<std::string_view, 9> action_shortcuts = {"ct", "cp", "p", "clr", "sh", "ed", "ad", "rm", "sw"};

EnumArray<std::string_view, 9> doing_action = {"Cutting", "Copying", "Pasting", "Clearing", "Editing", "Adding", "Removing", "Swapping"};

EnumArray<std::string_view, 9> did_action = {"Cut", "Copied", "Pasted", "Cleared", "Showed", "Edited", "Added", "Removed", "Swapped"};
...
Message help_message = "[info]▏This is Clipboard %s (commit %s), the cut, copy, and paste system for the command line.[blank]\n"
                       ...
                       "[progress]▏clipboard cut (item) [items][blank] [help](This cuts an item or items.)[blank]\n"
                       "[progress]▏clipboard copy (item) [items][blank] [help](This copies an item or items.)[blank]\n"
                       "[progress]▏clipboard paste[blank] [help](This pastes a clipboard.)[blank]\n"
                       "[progress]▏clipboard show[blank] [help](This shows what's in a clipboard.)[blank]\n"
                       "[progress]▏clipboard clear[blank] [help](This clears a clipboard's contents.)[blank]\n"
                       "[info]▏You can substitute \"cb\" for \"clipboard\" and use various shorthands for the actions to save "
                       "time.[blank]\n"
                       ...
                       "[info]▏You can show this help screen anytime with [bold]clipboard -h[blank][info], [bold]clipboard "
                       "--help[blank][info], or[bold] clipboard help[blank][info].\n"
...
void setLanguageES() {
    ...
    help_message = "[info]▏Esto es Clipboard %s (commit %s), el sistema para cortar, copiar y pegar adentro del "
                   ...
                   "[progress]▏clipboard cortar (cosa) [cosas][blank]\n"
                   "[progress]▏clipboard copiar (cosa) [cosas][blank]\n"
                   "[progress]▏clipboard pegar[blank]\n"
                   "[info]▏Reemplaza \"cb\" por \"clipboard\" para que gastes menos tiempo.[blank]\n"
                   "[info][bold]▏Ejemplos[blank]\n"
                   "[progress]▏clipboard copiar cosas.conf[blank]\n"
                   "[progress]▏cb cortar MisDocumentos.txt nuevacarpeta[blank]\n"
                   "[progress]▏cb pegar[blank]\n"
                   "[info]▏Muestra este mensaje de ayudar en cualquier tiempo que quieras con [bold]clipboard "
                   "-h[blank][info], [bold]clipboard --help[blank][info] o[bold] clipboard help[blank][info].\n"
                   "[info]▏Copyright (C) 2023 Jackson Huff. Licensed under the GPLv3.[blank]\n"
...
void setLanguagePT() {
    ...
    help_message = "[info]▏Este é Clipboard %s (commit %s), o sistema de recortar, copiar e colar para a linha de "
                   ...
                   "[progress]▏clipboard recortar (item) [itens][blank]\n"
                   "[progress]▏clipboard copiar (item) [itens][blank]\n"
                   "[progress]▏clipboard colar[blank]\n"
                   "[info] Você pode utilizar \"cb\" ao invés de \"clipboard\" para ganhar tempo.[blank]\n"
                   "[info][bold]▏Exemplos[blank]\n"
                   "[progress]▏clipboard copiar ração.conf[blank]\n"
                   "[progress]▏cb recortar Códigos_de_Lançamento_de_Mísseis.txt pastadecontatos[blank]\n"
                   "[progress]▏cb colar[blank]\n"
                   "[info]▏Você pode rever esta tela de instruções à qualquer momento com [bold]clipboard "
                   "-h[blank][info], [bold]clipboard --help[blank][info] ou[bold] clipboard help[blank][info].\n"
                   "[info]▏Copyright (C) 2023 Jackson Huff. Licensed under the GPLv3.[blank]\n"
...
void setLanguageTR() {
    ...
    help_message = "[info]▏Clipboard %s (commit %s), komut satırı için, kesme, kopyalama ve yapıştırma sistemidir.[blank]\n"
                   ...
                   "[progress]▏clipboard kes (öğe) [öğeler][blank] [help](Bu öğe(leri) keser.)[blank]\n"
                   "[progress]▏clipboard kopyala (öğe) [öğeler][blank] [help](Bu öğe(leri) kopyalar.)[blank]\n"
                   "[progress]▏clipboard yapistir[blank] [help](Bu panodakileri yapıştırır.)[blank]\n"
                   "[progress]▏clipboard goster[blank] [help](Bu panoda olan öğeleri gösterir.)[blank]\n"
                   "[progress]▏clipboard temizle[blank] [help](Bu pano içerğini temizler.)[blank]\n"
                   "[info]▏İşlemlerde uzun uzun yazarak zaman kaybetmemek için \"clipboard\" yerine \"cb\" kullanarak "
                   ...
                   "[info]▏    [bold]clipboard -h[blank][info], [bold]clipboard --help[blank][info], ya da[bold] clipboard "
                   "help[blank][info].\n"
